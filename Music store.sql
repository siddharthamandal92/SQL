--Q1:Who is the senior most employee based on job titel ?
...
--Q4:Which city has the highest sum of invoice total,return both city name and invoice total ?
...
--Q6:Write a quary to return the email,first name,last name & genre of all rocks music listeners.Return list ordered
...
--Q7:Lets invite the artists who have written the most rock music in datasate.
